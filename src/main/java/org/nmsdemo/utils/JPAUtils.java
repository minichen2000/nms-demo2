...
public class JPAUtils {
    ...
    static private AbstractApplicationContext _ctx=null;
    static public AbstractApplicationContext getJPAXMLCtx(){
        if(null==_ctx){
    ...
    static public void testNE() {
        MDL_NEDao dao = getJPAXMLCtx().getBean(MDL_NEDao.class);
