...
/***/ function(module, exports, __webpack_require__) {
	...
	var Grid = (function () {
        ...
        Grid.prototype.refreshCurrentDatasource = function () {
	        this.logger.log('refreshCurrentDatasource');
	        if (this.doingPagination) {
	            this.paginationController.loadPage();
	        }
	    };
        Grid.prototype.getLastScrollMS = function () {
	        return this.gridPanel.getLastScrollMS();
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GridPanel = (function () {
        ...
        GridPanel.prototype.getLastScrollMS=function(){
            return this.lastScrollMS;
        };
	    ...
	    GridPanel.prototype.addScrollListener = function () {
	        ...
	        this.eBodyViewport.addEventListener('scroll', function () {
                ...
                _this.lastScrollMS=(new Date()).getTime();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GridApi = (function () {
        ...
        GridApi.prototype.refreshCurrentDatasource = function () {
	        this.grid.refreshCurrentDatasource();
	    };
        GridApi.prototype.getLastScrollMS = function () {
	        return this.grid.getLastScrollMS();
	    };
