(function () {
    ...
    function SingleTrailController($stateParams, $state, commonUtil, $timeout) {
        ...
        vm.message =$stateParams.sncName;

        vm.breadcrumb=commonUtil.breadcrumb;
        vm.breadcrumb.add(vm.message, function(){
            commonUtil.treeNavWithLoadingPage($state, $timeout, 'main.treeitem_secondlevel', { treeItemId: 'trail', sncId: $stateParams.sncId, sncName: $stateParams.sncName }, false);
        });
    }
})();